...
class AsyncHandlerTwo
{
    ...
    {
        $this->_logger->debug('Lokeshyourfriend_AsyncMsgQueueOverride: AsyncHandlerTwo This is called from the handle defined in the communication.xml file. parameter value is : ' . $param);
        return;
    }
