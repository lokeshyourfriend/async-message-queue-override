...
class ApiAsyncHandlerTwo
{
    ...
    {
        $this->_logger->debug('Lokeshyourfriend_AsyncMsgQueueOverride - ApiAsyncHandlerTwo: This is called from the handle defined in the webapi.xml file.');
        return;
    }
