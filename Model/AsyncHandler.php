...
class AsyncHandler
{
    ...
    {
        $this->_logger->debug('Lokeshyourfriend_AsyncMsgQueueOverride: This is called from the handle defined in the communication.xml file. parameter value is : ' . $param);
        return;
    }
